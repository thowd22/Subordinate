...
pub mod codes {
    ...
    /// A project file is not JSON, is not shaped like a project, or carries a
    /// value the model rejects.
    pub const INVALID_PROJECT_FILE: ErrorCode =
        ErrorCode::from_static("model.invalid_project_file");
