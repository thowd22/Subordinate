...
use eframe::egui::{
    Align2, Color32, Context, CornerRadius, FontId, Rect, Response, Sense, Stroke, StrokeKind, Ui,
    Vec2, Visuals, pos2,
};
...
impl TimelinePanel {
    ...
    fn paint_clips(
        ...
        for placement in self.view.visible_clips(index) {
            ...
            self.paint_waveform(painter, rect, clip, kind, !clip_edits_allowed(track));
        }
    }
