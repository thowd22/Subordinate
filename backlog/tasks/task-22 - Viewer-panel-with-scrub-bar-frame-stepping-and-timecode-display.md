...
2026-09-10: the 4K hardware-decode scrub measurement moved to TASK-118 (NVIDIA GPU runner job), which already lists it. Remaining criteria verified.
<!-- SECTION:NOTES:END -->

## Final Summary

<!-- SECTION:FINAL_SUMMARY:BEGIN -->
Viewer panel with scrub bar, frame stepping and timecode; verified by tests and CI. Hardware scrub rate is measured by TASK-118.
